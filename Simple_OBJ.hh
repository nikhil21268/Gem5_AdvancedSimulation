#ifndef __LEARNING_GEM5_SIMPLE_OBJ_HH__
#define __LEARNING_GEM5_SIMPLE_OBJ_HH__

#include "mem/port.hh"
#include "params/SimpleOBJ.hh"
#include "sim/sim_object.hh" // Ensure this path is correct and the file exists
using namespace gem5; // Add the correct namespace if SimObject is within a namespace
...
class SimpleOBJ : public SimObject {
  private:
    ...
    class CPUSidePort : public ResponsePort
    {
      ...
      public:
         ...
         */
        CPUSidePort(const std::string& name, SimpleOBJ *owner) :
    ...
    class MemSidePort : public RequestPort
    {
      ...
      public:
         ...
         * Constructor. Just calls the superclass constructor.
         */
        MemSidePort(const std::string& name, SimpleOBJ *owner) :
  ...
  public:
    ...
    /** constructor
     */
    SimpleOBJ(const SimpleOBJParams &params);
...
#endif // __LEARNING_GEM5_SIMPLE_OBJ_HH__